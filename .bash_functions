...
screen_set() {
  case $1 in
   ...
   work-laptop-right) {
    ...
    ;;
    home) {
      xrandr --output eDP-1                     --mode 3840x2400 --pos 3840x0 --rotate normal \
             --output DP-1  --primary --scale 2 --mode 1920x1080 --pos    0x0 --rotate normal; } || {
      xrandr --output eDP-1                     --mode 3840x2400 --pos 3840x0 --rotate normal \
             --output DP-2  --primary --scale 2 --mode 1920x1080 --pos    0x0  --rotate normal; }
      ;;
    *)
